	...
	#define V_COMMIT_HASH "92f19f5"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "76dc4cf"
#endif
...
byteptr realloc_data(byteptr old_data, int old_size, int new_size);
...
VV_LOCAL_SYMBOL Array_string main__App_get(main__App* app, string db_entry);
VV_LOCAL_SYMBOL Option_Array_string main__App_find_path(main__App* app, string start, string target);
VV_LOCAL_SYMBOL Array_string main__App_dfs(main__App* app, string node, string target, int depth, int limit, Array_string path_);
...
inline u64 hash__sum64_string(string key, u64 seed) {
	/*tmp return var*/ u64 _t11 = hash__wyhash64(key.str, ((u64)(key.len)), seed);
...
inline u64 hash__sum64(Array_byte key, u64 seed) {
	/*tmp return var*/ u64 _t12 = hash__wyhash64(((byteptr)(key.data)), ((u64)(key.len)), seed);
...
inline VV_LOCAL_SYMBOL u64 hash__wyhash64(byteptr key, u64 len, u64 seed_) {
	...
	if (i == len) {
		/*tmp return var*/ u64 _t15 = hash__wymum(seed, (len ^ _const_hash__wyp4));
	...
	/*tmp return var*/ u64 _t16 = hash__wymum(((seed ^ see1) ^ see2), ((see3 ^ len) ^ _const_hash__wyp4));
...
inline VV_LOCAL_SYMBOL u64 hash__wyrotr(u64 v, u32 k) {
	/*tmp return var*/ u64 _t17 = ((v >> k) | (v << (64 - k)));
...
inline VV_LOCAL_SYMBOL u64 hash__wyr3(byteptr p, u64 k) {
	{ // Unsafe block
		/*tmp return var*/ u64 _t19 = (((((u64)(p[0])) << 16) | (((u64)(p[k >> 1])) << 8)) | ((u64)(p[k - 1])));
...
inline VV_LOCAL_SYMBOL u64 hash__wyr4(byteptr p) {
	{ // Unsafe block
		/*tmp return var*/ u64 _t20 = (((((u32)(p[0])) | (((u32)(p[1])) << ((u32)(8U)))) | (((u32)(p[2])) << ((u32)(16U)))) | (((u32)(p[3])) << ((u32)(24U))));
...
inline VV_LOCAL_SYMBOL u64 hash__wyr8(byteptr p) {
	{ // Unsafe block
		/*tmp return var*/ u64 _t21 = (((((((((u64)(p[0])) | (((u64)(p[1])) << 8)) | (((u64)(p[2])) << 16)) | (((u64)(p[3])) << 24)) | (((u64)(p[4])) << 32)) | (((u64)(p[5])) << 40)) | (((u64)(p[6])) << 48)) | (((u64)(p[7])) << 56));
...
int math__bits__leading_zeros_8(byte x) {
	/*tmp return var*/ int _t22 = 8 - math__bits__len_8(x);
...
int math__bits__leading_zeros_16(u16 x) {
	/*tmp return var*/ int _t23 = 16 - math__bits__len_16(x);
...
int math__bits__leading_zeros_32(u32 x) {
	/*tmp return var*/ int _t24 = 32 - math__bits__len_32(x);
...
int math__bits__leading_zeros_64(u64 x) {
	/*tmp return var*/ int _t25 = 64 - math__bits__len_64(x);
...
int math__bits__trailing_zeros_8(byte x) {
	/*tmp return var*/ int _t26 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__ntz_8_tab, x))));
...
int math__bits__trailing_zeros_16(u16 x) {
	...
	/*tmp return var*/ int _t28 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__de_bruijn32tab, ((u32)((x & -x))) * _const_math__bits__de_bruijn32 >> (32 - 5)))));
...
int math__bits__trailing_zeros_32(u32 x) {
	...
	/*tmp return var*/ int _t30 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__de_bruijn32tab, ((x & -x)) * _const_math__bits__de_bruijn32 >> (32 - 5)))));
...
int math__bits__trailing_zeros_64(u64 x) {
	...
	/*tmp return var*/ int _t32 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__de_bruijn64tab, ((x & -x)) * _const_math__bits__de_bruijn64 >> (64 - 6)))));
...
int math__bits__ones_count_8(byte x) {
	/*tmp return var*/ int _t33 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, x))));
...
int math__bits__ones_count_16(u16 x) {
	/*tmp return var*/ int _t34 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, x >> 8)) + (*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, (x & ((u16)(0xffU)))))));
...
int math__bits__ones_count_32(u32 x) {
	/*tmp return var*/ int _t35 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, x >> 24)) + (*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, (x >> 16 & 0xff))) + (*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, (x >> 8 & 0xff))) + (*(byte*)/*ee elem_typ */array_get(_const_math__bits__pop_8_tab, (x & ((u32)(0xffU)))))));
...
int math__bits__ones_count_64(u64 x) {
	...
	y += y >> 16;
	y += y >> 32;
	/*tmp return var*/ int _t36 = (((int)(y)) & ((1 << 7) - 1));
...
inline byte math__bits__rotate_left_8(byte x, int k) {
	...
	/*tmp return var*/ byte _t37 = (((x << s) | (x >> (n - s))));
...
inline u16 math__bits__rotate_left_16(u16 x, int k) {
	...
	/*tmp return var*/ u16 _t38 = (((x << s) | (x >> (n - s))));
...
inline u32 math__bits__rotate_left_32(u32 x, int k) {
	...
	/*tmp return var*/ u32 _t39 = (((x << s) | (x >> (n - s))));
...
inline u64 math__bits__rotate_left_64(u64 x, int k) {
	...
	/*tmp return var*/ u64 _t40 = (((x << s) | (x >> (n - s))));
...
inline byte math__bits__reverse_8(byte x) {
	/*tmp return var*/ byte _t41 = (*(byte*)/*ee elem_typ */array_get(_const_math__bits__rev_8_tab, x));
...
inline u16 math__bits__reverse_16(u16 x) {
	/*tmp return var*/ u16 _t42 = (((u16)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__rev_8_tab, x >> 8)))) | (((u16)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__rev_8_tab, (x & ((u16)(0xffU))))))) << 8));
...
inline u32 math__bits__reverse_32(u32 x) {
	...
	/*tmp return var*/ u32 _t43 = math__bits__reverse_bytes_32(((u32)(y)));
...
inline u64 math__bits__reverse_64(u64 x) {
	...
	/*tmp return var*/ u64 _t44 = math__bits__reverse_bytes_64(y);
...
inline u16 math__bits__reverse_bytes_16(u16 x) {
	/*tmp return var*/ u16 _t45 = ((x >> 8) | (x << 8));
...
inline u32 math__bits__reverse_bytes_32(u32 x) {
	...
	/*tmp return var*/ u32 _t46 = ((u32)(((y >> 16) | (y << 16))));
...
inline u64 math__bits__reverse_bytes_64(u64 x) {
	...
	/*tmp return var*/ u64 _t47 = ((y >> 32) | (y << 32));
...
int math__bits__len_8(byte x) {
	/*tmp return var*/ int _t48 = ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__len_8_tab, x))));
...
int math__bits__len_16(u16 x) {
	...
	/*tmp return var*/ int _t49 = n + ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__len_8_tab, y))));
...
int math__bits__len_32(u32 x) {
	...
	/*tmp return var*/ int _t50 = n + ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__len_8_tab, y))));
...
int math__bits__len_64(u64 x) {
	...
	/*tmp return var*/ int _t51 = n + ((int)((*(byte*)/*ee elem_typ */array_get(_const_math__bits__len_8_tab, y))));
...
u32 math__bits__rem_32(u32 hi, u32 lo, u32 y) {
	/*tmp return var*/ u32 _t52 = ((u32)((((((u64)(hi)) << 32) | ((u64)(lo)))) % ((u64)(y))));
...
inline VV_LOCAL_SYMBOL DenseArray new_dense_array(int key_bytes, int value_bytes) {
	int key_bytes_ = key_bytes;
	int value_bytes_ = value_bytes;
	#if defined(_VGCBOEHM)
	{
	}
	#endif
	int slot_bytes = key_bytes_ + value_bytes_;
	int cap = 8;
	return (DenseArray){
		.key_bytes = key_bytes,
...
inline VV_LOCAL_SYMBOL voidptr DenseArray_value(DenseArray* d, int i) {
	return d->data + i * d->slot_bytes + d->key_bytes_;
}
...
inline VV_LOCAL_SYMBOL int DenseArray_expand(DenseArray* d) {
	int old_cap = d->cap;
	int old_size = d->slot_bytes * old_cap;
	if (d->cap == d->len) {
		d->cap += d->cap >> 3;
		{ // Unsafe block
...
inline VV_LOCAL_SYMBOL void map_ensure_extra_metas(map* m, u32 probe_count) {
	if ((probe_count << 1) == m->extra_metas) {
		...
		{ // Unsafe block
			byteptr x = realloc_data(((byteptr)(m->metas)), ((int)(size_of_u32 * old_mem_size)), ((int)(size_of_u32 * mem_size)));
			m->metas = ((u32*)(x));
...
VV_LOCAL_SYMBOL void map_set_1(map* m, voidptr key, voidptr value) {
	...
	multi_return_u32_u32 mr_12840 = map_key_to_index(m, key);
	u32 index = mr_12840.arg0;
	u32 meta = mr_12840.arg1;
	multi_return_u32_u32 mr_12876 = map_meta_less(m, index, meta);
	index = mr_12876.arg0;
	meta = mr_12876.arg1;
	for (;;) {
		if (!(meta == m->metas[index])) break;
		...
		if (m->key_eq_fn(key, pkey)) {
			{ // Unsafe block
				byteptr pval = ((byteptr)(pkey)) + m->key_bytes_;
	...
	{ // Unsafe block
		voidptr pkey = DenseArray_key(&m->key_values, kv_index);
		m->clone_fn(pkey, key);
		memcpy(((byteptr)(pkey)) + m->key_bytes_, value, m->value_bytes);
	}
...
VV_LOCAL_SYMBOL void map_rehash(map* m) {
	...
	for (int i = 0; i < m->key_values.len; i++) {
		...
		multi_return_u32_u32 mr_14517 = map_key_to_index(m, pkey);
		u32 index = mr_14517.arg0;
		u32 meta = mr_14517.arg1;
		multi_return_u32_u32 mr_14555 = map_meta_less(m, index, meta);
		index = mr_14555.arg0;
		meta = mr_14555.arg1;
...
VV_LOCAL_SYMBOL void map_cached_rehash(map* m, u32 old_cap) {
	...
	for (u32 i = ((u32)(0U)); i <= old_cap + old_extra_metas; i += 2) {
		...
		multi_return_u32_u32 mr_15343 = map_meta_less(m, index, meta);
		index = mr_15343.arg0;
		meta = mr_15343.arg1;
...
VV_LOCAL_SYMBOL voidptr map_get_and_set_1(map* m, voidptr key, voidptr zero) {
	for (;;) {
		multi_return_u32_u32 mr_15793 = map_key_to_index(m, key);
		u32 index = mr_15793.arg0;
		u32 meta = mr_15793.arg1;
		for (;;) {
			if (meta == m->metas[index]) {
				int kv_index = ((int)(m->metas[index + 1]));
				voidptr pkey = DenseArray_key(&m->key_values, kv_index);
				if (m->key_eq_fn(key, pkey)) {
					return ((byteptr)(pkey)) + m->key_values.key_bytes_;
				}
			}
			index += 2;
			meta += _const_probe_inc;
	...
	if (!(false)) {
		...
		v_assert_meta_info__t67.fpath = _SLIT("C:\\\\Users\\\\spaceface\\\\Desktop\\\\v\\\\vlib\\\\builtin\\\\map.v");
		v_assert_meta_info__t67.line_nr = 562;
...
VV_LOCAL_SYMBOL voidptr map_get_1(map* m, voidptr key, voidptr zero) {
	multi_return_u32_u32 mr_16511 = map_key_to_index(m, key);
	u32 index = mr_16511.arg0;
	u32 meta = mr_16511.arg1;
	for (;;) {
		if (meta == m->metas[index]) {
			int kv_index = ((int)(m->metas[index + 1]));
			voidptr pkey = DenseArray_key(&m->key_values, kv_index);
...
VV_LOCAL_SYMBOL voidptr map_get_1_check(map* m, voidptr key) {
	multi_return_u32_u32 mr_17156 = map_key_to_index(m, key);
	u32 index = mr_17156.arg0;
	u32 meta = mr_17156.arg1;
	for (;;) {
		if (meta == m->metas[index]) {
			int kv_index = ((int)(m->metas[index + 1]));
			voidptr pkey = DenseArray_key(&m->key_values, kv_index);
...
VV_LOCAL_SYMBOL bool map_exists_1(map* m, voidptr key) {
	multi_return_u32_u32 mr_17646 = map_key_to_index(m, key);
	u32 index = mr_17646.arg0;
	u32 meta = mr_17646.arg1;
	for (;;) {
		if (meta == m->metas[index]) {
			int kv_index = ((int)(m->metas[index + 1]));
			voidptr pkey = DenseArray_key(&m->key_values, kv_index);
...
// Attr: [unsafe]
void map_delete_1(map* m, voidptr key) {
	multi_return_u32_u32 mr_18367 = map_key_to_index(m, key);
	u32 index = mr_18367.arg0;
	u32 meta = mr_18367.arg1;
	multi_return_u32_u32 mr_18403 = map_meta_less(m, index, meta);
	index = mr_18403.arg0;
	meta = mr_18403.arg1;
	for (;;) {
		if (!(meta == m->metas[index])) break;
...
// Attr: [unsafe]
string charptr_vstring(charptr cp) {
	return (string){.str = ((byteptr)(cp)), .len = strlen(cp), .is_lit = 0};
}
...
// Attr: [unsafe]
string byteptr_vstring_literal(byteptr bp) {
	return (string){.str = bp, .len = strlen(((charptr)(bp))), .is_lit = 1};
}
...
// Attr: [unsafe]
string charptr_vstring_literal(charptr cp) {
	return (string){.str = ((byteptr)(cp)), .len = strlen(cp), .is_lit = 1};
}
...
int os__setenv(string name, string value, bool overwrite) {
	#if defined(_WIN32)
	{
		...
		if (overwrite) {
			{ // Unsafe block
				return _putenv(((charptr)(format.str)));
			}
		} else {
...
Array_string os__fd_slurp(int fd) {
	Array_string res = __new_array_with_default(0, 0, sizeof(string), 0);
	for (;;) {
		multi_return_string_int mr_486 = os__fd_read(fd, 4096);
		string s = mr_486.arg0;
		int b = mr_486.arg1;
		if (b <= 0) {
			break;
		}
...
Option_os__File os__open_file(string path, string mode, Array_int options) {
	...
	FILE* cfile = fdopen(fd, ((charptr)(mode.str)));
	if (isnil(cfile)) {
...
Option_void os__cp_all(string src, string dst, bool overwrite) {
	...
	if (!os__is_dir(source_path)) {
		...
		if (os__exists(adjusted_path)) {
			if (overwrite) {
				...
				if (_t130.state != 0 && _t130.err._interface_idx != _IError_None___index) {
					Option_void _t131;
		...
		if (_t132.state != 0 && _t132.err._interface_idx != _IError_None___index) {
			Option_void _t133;
	...
	for (int _t138 = 0; _t138 < files.len; ++_t138) {
		...
		if (_t141.state != 0 && _t141.err._interface_idx != _IError_None___index) {
			IError err = _t141.err;
			Option_void _t142 = os__rmdir(dp);
			if (_t142.state != 0 && _t142.err._interface_idx != _IError_None___index) {
				err = _t142.err;
				return (Option_void){.state=2, .err=err };
			};
			return (Option_void){.state=2, .err=err };
...
Option_void os__mv_by_cp(string source, string target) {
	...
	if (_t143.state != 0 && _t143.err._interface_idx != _IError_None___index) {
		Option_void _t144;
		memcpy(&_t144, &_t143, sizeof(Option));
		return _t144;
	};
	Option_void _t145 = os__rm(source);
	if (_t145.state != 0 && _t145.err._interface_idx != _IError_None___index) {
		Option_void _t146;
...
Option_void os__rmdir_all(string path) {
	...
	for (int _t157 = 0; _t157 < items.len; ++_t157) {
		...
		if (os__is_dir(fullpath)) {
			...
			if (_t158.state != 0 && _t158.err._interface_idx != _IError_None___index) {
				IError err = _t158.err;
				ret_err = (*(err.msg));
			};
		} else {
			Option_void _t159 = os__rm(fullpath);
			if (_t159.state != 0 && _t159.err._interface_idx != _IError_None___index) {
	...
	if (_t160.state != 0 && _t160.err._interface_idx != _IError_None___index) {
...
bool os__read_file_defer_0 = false;
	...
	{ // Unsafe block
		...
		// Defer end
		Option_string _t201;
		opt_ok(&(string[]) { byteptr_vstring_with_len(str, fsize) }, (Option*)(&_t201), sizeof(string));
		return _t201;
	}
	...
	{ // Unsafe block
		#if defined(TARGET_IS_64BIT)
		{
			#if defined(_WIN32)
			{
				...
				_wstat64(string_to_wide(path), ((voidptr)(&swin)));
				return swin.st_size;
			}
			#else
			{
...
Option_void os__execvp(string cmdpath, Array_string args) {
	Array_charptr cargs = __new_array_with_default(0, 0, sizeof(charptr), 0);
	array_push(&cargs, _MOV((charptr[]){ ((charptr)(cmdpath.str)) }));
	for (int i = 0; i < args.len; ++i) {
		array_push(&cargs, _MOV((charptr[]){ ((charptr)((*(string*)/*ee elem_typ */array_get(args, i)).str)) }));
	}
	array_push(&cargs, _MOV((charptr[]){ ((charptr)(0)) }));
	int res = execvp(((charptr)(cmdpath.str)), cargs.data);
	if (res == -1) {
...
Option_void os__execve(string cmdpath, Array_string args, Array_string envs) {
	...
	array_push(&cargv, _MOV((charptr[]){ ((charptr)(cmdpath.str)) }));
	for (int i = 0; i < args.len; ++i) {
		array_push(&cargv, _MOV((charptr[]){ ((charptr)((*(string*)/*ee elem_typ */array_get(args, i)).str)) }));
	}
	for (int i = 0; i < envs.len; ++i) {
		array_push(&cenvs, _MOV((charptr[]){ ((charptr)((*(string*)/*ee elem_typ */array_get(envs, i)).str)) }));
	}
	array_push(&cargv, _MOV((charptr[]){ ((charptr)(0)) }));
	array_push(&cenvs, _MOV((charptr[]){ ((charptr)(0)) }));
	int res = execve(((charptr)(cmdpath.str)), cargv.data, cenvs.data);
	if (res == -1) {
		return (Option_void){.state=2, .err=error_with_code(os__posix_get_error_msg(errno), errno) };
	}
	return (Option_void){0};
...
Option_bool os__is_writable_folder(string folder) {
	...
	if (_t222.state != 0 && _t222.err._interface_idx != _IError_None___index) {
		Option_bool _t223;
...
os__Process* os__new_process(string filename) {
	return (os__Process*)memdup(&(os__Process){.filename = filename,.pid = 0,.code = -1,.status = os__ProcessState_not_started,.err = (string){.str=(byteptr)"", .is_lit=1},.args = __new_array(0, 1, sizeof(string)),.env_is_custom = 0,.env = __new_array(0, 1, sizeof(string)),.use_stdio_ctl = 0,.stdio_fd = {0},}, sizeof(os__Process));
}
...
VV_LOCAL_SYMBOL int os__Process_win_spawn_process(os__Process* p) {
	eprintln(_SLIT("TODO implement waiting for a process on windows"));
	return 12345;
}

VV_LOCAL_SYMBOL void os__Process_win_stop_process(os__Process* p) {
	eprintln(_SLIT("TODO implement stopping a process on windows"));
}

VV_LOCAL_SYMBOL void os__Process_win_resume_process(os__Process* p) {
	eprintln(_SLIT("TODO implement resuming a process on windows"));
}

VV_LOCAL_SYMBOL void os__Process_win_kill_process(os__Process* p) {
	eprintln(_SLIT("TODO implement killing a process on windows"));
}
...
VV_LOCAL_SYMBOL bool os__Process_win_is_alive(os__Process* p) {
	eprintln(_SLIT("TODO implement checking whether the process is still alive on windows"));
	return false;
}
...
string sqlite__DB_str(sqlite__DB db) {
	/*tmp return var*/ string _t233 = string_add(string_add(_SLIT("sqlite.DB{ conn: "), ptr_str(db.conn)), _SLIT(" }"));
...
Option_sqlite__DB sqlite__connect(string path) {
	...
	Option_sqlite__DB _t234;
	opt_ok(&(sqlite__DB[]) { (sqlite__DB){.is_open = true,.conn = db,} }, (Option*)(&_t234), sizeof(sqlite__DB));
	return _t234;
}
...
Option_bool sqlite__DB_close(sqlite__DB* db) {
	...
	Option_bool _t235;
	opt_ok(&(bool[]) { true }, (Option*)(&_t235), sizeof(bool));
	return _t235;
}
...
Option_sqlite__Row sqlite__DB_exec_one(sqlite__DB db, string query) {
	...
	Option_sqlite__Row _t238;
	opt_ok(&(sqlite__Row[]) { (*(sqlite__Row*)/*ee elem_typ */array_get(rows, 0)) }, (Option*)(&_t238), sizeof(sqlite__Row));
	return _t238;
}
...
string time__Time_format(time__Time t) {
	/*tmp return var*/ string _t239 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmm24, time__FormatDate_yyyymmdd);
...
string time__Time_format_ss(time__Time t) {
	/*tmp return var*/ string _t240 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmmss24, time__FormatDate_yyyymmdd);
...
string time__Time_format_ss_milli(time__Time t) {
	/*tmp return var*/ string _t241 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmmss24_milli, time__FormatDate_yyyymmdd);
...
string time__Time_format_ss_micro(time__Time t) {
	/*tmp return var*/ string _t242 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmmss24_micro, time__FormatDate_yyyymmdd);
...
string time__Time_hhmm(time__Time t) {
	/*tmp return var*/ string _t243 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm24);
...
string time__Time_hhmmss(time__Time t) {
	/*tmp return var*/ string _t244 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmmss24);
...
string time__Time_hhmm12(time__Time t) {
	/*tmp return var*/ string _t245 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm12);
...
string time__Time_ymmdd(time__Time t) {
	/*tmp return var*/ string _t246 = time__Time_get_fmt_date_str(t, time__FormatDelimiter_hyphen, time__FormatDate_yyyymmdd);
...
string time__Time_ddmmy(time__Time t) {
	/*tmp return var*/ string _t247 = time__Time_get_fmt_date_str(t, time__FormatDelimiter_dot, time__FormatDate_ddmmyyyy);
...
string time__Time_md(time__Time t) {
	/*tmp return var*/ string _t248 = time__Time_get_fmt_date_str(t, time__FormatDelimiter_space, time__FormatDate_mmmd);
...
string time__Time_clean(time__Time t) {
	...
	if (t.month == znow.month && t.year == znow.year && t.day == znow.day) {
		/*tmp return var*/ string _t249 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm24);
	...
	if (t.year == znow.year) {
		/*tmp return var*/ string _t250 = time__Time_get_fmt_str(t, time__FormatDelimiter_space, time__FormatTime_hhmm24, time__FormatDate_mmmd);
	...
	/*tmp return var*/ string _t251 = time__Time_format(t);
...
string time__Time_clean12(time__Time t) {
	time__Time znow = time__now();
	if (t.month == znow.month && t.year == znow.year && t.day == znow.day) {
		/*tmp return var*/ string _t252 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm12);
	...
	if (t.year == znow.year) {
		/*tmp return var*/ string _t253 = time__Time_get_fmt_str(t, time__FormatDelimiter_space, time__FormatTime_hhmm12, time__FormatDate_mmmd);
	...
	/*tmp return var*/ string _t254 = time__Time_format(t);
...
string time__Time_get_fmt_time_str(time__Time t, time__FormatTime fmt_time) {
	if (fmt_time == time__FormatTime_no_time) {
		/*tmp return var*/ string _t255 = _SLIT("");
...
string time__Time_get_fmt_date_str(time__Time t, time__FormatDelimiter fmt_dlmtr, time__FormatDate fmt_date) {
	if (fmt_date == time__FormatDate_no_date) {
		/*tmp return var*/ string _t257 = _SLIT("");
...
string time__Time_get_fmt_str(time__Time t, time__FormatDelimiter fmt_dlmtr, time__FormatTime fmt_time, time__FormatDate fmt_date) {
	if (fmt_date == time__FormatDate_no_date) {
		if (fmt_time == time__FormatTime_no_time) {
			/*tmp return var*/ string _t258 = _SLIT("");
			...
			/*tmp return var*/ string _t259 = time__Time_get_fmt_time_str(t, fmt_time);
		...
		if (fmt_time != time__FormatTime_no_time) {
			/*tmp return var*/ string _t260 = string_add(string_add(time__Time_get_fmt_date_str(t, fmt_dlmtr, fmt_date), _SLIT(" ")), time__Time_get_fmt_time_str(t, fmt_time));
			...
			/*tmp return var*/ string _t261 = time__Time_get_fmt_date_str(t, fmt_dlmtr, fmt_date);
...
inline bool time__Time__eq(time__Time t1, time__Time t2) {
	/*tmp return var*/ bool _t262 = t1.v_unix == t2.v_unix && t1.microsecond == t2.microsecond;
...
inline bool time__Time__lt(time__Time t1, time__Time t2) {
	/*tmp return var*/ bool _t263 = t1.v_unix < t2.v_unix || (t1.v_unix == t2.v_unix && t1.microsecond < t2.microsecond);
...
inline time__Duration time__Time__minus(time__Time lhs, time__Time rhs) {
	...
	/*tmp return var*/ time__Duration _t264 = (((i64)(lhs_micro)) - ((i64)(rhs_micro))) * _const_time__microsecond;
...
Option_time__Time time__parse(string s) {
	...
	Option_time__Time _t266;
	opt_ok(&(time__Time[]) { res }, (Option*)(&_t266), sizeof(time__Time));
	return _t266;
}
...
Option_time__Time time__parse_rfc2822(string s) {
	...
	Option_int _t267 = string_index(_const_time__months_string, (*(string*)/*ee elem_typ */array_get(fields, 2)));
	if (_t267.state != 0) { /*or block*/ 
		IError err = _t267.err;
		return (Option_time__Time){.state=2, .err=v_error(_STR("Invalid time format: %.*s", 1, s)) };
	}
 	int pos =  *(int*)_t267.data;
	int mm = pos / 3 + 1;
	{ // Unsafe block
		...
		/*tmp return var*/ Option_time__Time _t268 = time__parse(tos(tmstr, count));
		// autofree_scope_vars(pos=1209 line_nr=41 scope.pos=1061 scope.end_pos=1243)
...
VV_LOCAL_SYMBOL Option_multi_return_int_int_int time__parse_iso8601_date(string s) {
	...
	Option_multi_return_int_int_int _t269;
	opt_ok(&(multi_return_int_int_int/*X*/[]) { (multi_return_int_int_int){.arg0=year, .arg1=month, .arg2=day} }, (Option*)(&_t269), sizeof(multi_return_int_int_int));
	return _t269;
}
...
VV_LOCAL_SYMBOL Option_multi_return_int_int_int_int_i64_bool time__parse_iso8601_time(string s) {
	...
	Option_multi_return_int_int_int_int_i64_bool _t270;
	opt_ok(&(multi_return_int_int_int_int_i64_bool/*X*/[]) { (multi_return_int_int_int_int_i64_bool){.arg0=hour_, .arg1=minute_, .arg2=second_, .arg3=microsecond_, .arg4=unix_offset, .arg5=is_local_time} }, (Option*)(&_t270), sizeof(multi_return_int_int_int_int_i64_bool));
	return _t270;
}

Option_time__Time time__parse_iso8601(string s) {
	Option_int _t271 = string_index(s, _SLIT("T"));
	if (_t271.state != 0) { /*or block*/ 
		IError err = _t271.err;
		*(int*) _t271.data = -1;
	}
 	int t_i =  *(int*)_t271.data;
	...
	Option_multi_return_int_int_int _t272 = time__parse_iso8601_date((*(string*)/*ee elem_typ */array_get(parts, 0)));
	if (_t272.state != 0) { /*or block*/ 
		Option_time__Time _t273;
		memcpy(&_t273, &_t272, sizeof(Option));
		return _t273;
	}
 	Option_multi_return_int_int_int mr_3473 =  _t272 /*U*/;
	...
	if (parts.len == 2) {
		Option_multi_return_int_int_int_int_i64_bool _t274 = time__parse_iso8601_time((*(string*)/*ee elem_typ */array_get(parts, 1)));
		if (_t274.state != 0) { /*or block*/ 
			Option_time__Time _t275;
			memcpy(&_t275, &_t274, sizeof(Option));
			return _t275;
		}
 		Option_multi_return_int_int_int_int_i64_bool mr_3715 =  _t274 /*U*/;
	...
	if (is_local_time) {
		Option_time__Time _t276;
		opt_ok(&(time__Time[]) { t }, (Option*)(&_t276), sizeof(time__Time));
		return _t276;
	}
	...
	Option_time__Time _t277;
	opt_ok(&(time__Time[]) { t }, (Option*)(&_t277), sizeof(time__Time));
	return _t277;
}
...
time__StopWatch time__new_stopwatch(time__StopWatchOptions opts) {
	...
	/*tmp return var*/ time__StopWatch _t278 = (time__StopWatch){.elapsed = 0,.start = initial,.end = 0,};
...
time__Duration time__StopWatch_elapsed(time__StopWatch t) {
	if (t.start > 0) {
		if (t.end == 0) {
			/*tmp return var*/ time__Duration _t279 = ((((i64)(time__sys_mono_now() - t.start + t.elapsed))));
			...
			/*tmp return var*/ time__Duration _t280 = ((((i64)(t.end - t.start + t.elapsed))));
	...
	/*tmp return var*/ time__Duration _t281 = ((((i64)(t.elapsed))));
...
time__Time time__now(void) {
	...
	#if defined(_WIN32)
	{
		/*tmp return var*/ time__Time _t282 = time__win_now();
	...
	/*tmp return var*/ time__Time _t283 = time__convert_ctime(*now, 0);
...
time__Time time__utc(void) {
	...
	#if defined(_WIN32)
	{
		/*tmp return var*/ time__Time _t284 = time__win_utc();
	...
	time_t t = time(0);
	time(&t);
	/*tmp return var*/ time__Time _t285 = time__unix2(((int)(t)), 0);
...
string time__Time_smonth(time__Time t) {
	if (t.month <= 0 || t.month > 12) {
		/*tmp return var*/ string _t286 = _SLIT("---");
	...
	int i = t.month - 1;
	/*tmp return var*/ string _t287 = string_substr(_const_time__months_string, i * 3, (i + 1) * 3);
...
time__Time time__new_time(time__Time t) {
	...
	/*tmp return var*/ time__Time _t288 = (time__Time){t.year,t.month,t.day,t.hour,t.minute,t.second,t.microsecond,.v_unix = utime,};
...
inline int time__Time_unix_time(time__Time t) {
	/*tmp return var*/ int _t289 = ((int)(t.v_unix));
...
inline u64 time__Time_unix_time_milli(time__Time t) {
	/*tmp return var*/ u64 _t290 = t.v_unix * 1000 + ((u64)(t.microsecond / 1000));
...
time__Time time__Time_add(time__Time t, time__Duration d) {
	...
	/*tmp return var*/ time__Time _t291 = time__unix2(((int)(v_unix)), ((int)(micro)));
...
time__Time time__Time_add_seconds(time__Time t, int seconds) {
	/*tmp return var*/ time__Time _t292 = time__Time_add(t, seconds * _const_time__second);
...
time__Time time__Time_add_days(time__Time t, int days) {
	/*tmp return var*/ time__Time _t293 = time__Time_add(t, days * 24 * _const_time__hour);
...
string time__Time_relative(time__Time t) {
	...
	if (secs <= 30) {
		/*tmp return var*/ string _t295 = _SLIT("now");
	...
	if (secs < 60) {
		/*tmp return var*/ string _t296 = _SLIT("1m");
	...
	if (secs < 3600) {
		u64 m = secs / 60;
		if (m == 1) {
			/*tmp return var*/ string _t297 = _SLIT("1 minute ago");
		...
		/*tmp return var*/ string _t298 = _STR("%"PRIu64"\000 minutes ago", 2, m);
	...
	if (secs < 3600 * 24) {
		u64 h = secs / 3600;
		if (h == 1) {
			/*tmp return var*/ string _t299 = _SLIT("1 hour ago");
		...
		/*tmp return var*/ string _t300 = _STR("%"PRIu64"\000 hours ago", 2, h);
	...
	if (secs < 3600 * 24 * 5) {
		u64 d = secs / 3600 / 24;
		if (d == 1) {
			/*tmp return var*/ string _t301 = _SLIT("1 day ago");
		...
		/*tmp return var*/ string _t302 = _STR("%"PRIu64"\000 days ago", 2, d);
	...
	if (secs > 3600 * 24 * 10000) {
		/*tmp return var*/ string _t303 = _SLIT("");
	...
	/*tmp return var*/ string _t304 = time__Time_md(t);
...
string time__Time_relative_short(time__Time t) {
	...
	u64 secs = znow.v_unix - t.v_unix;
	if (secs <= 30) {
		/*tmp return var*/ string _t305 = _SLIT("now");
	...
	if (secs < 60) {
		/*tmp return var*/ string _t306 = _SLIT("1m");
	...
	if (secs < 3600) {
		/*tmp return var*/ string _t307 = _STR("%"PRIu64"\000m", 2, secs / 60);
	...
	if (secs < 3600 * 24) {
		/*tmp return var*/ string _t308 = _STR("%"PRIu64"\000h", 2, secs / 3600);
	...
	if (secs < 3600 * 24 * 5) {
		/*tmp return var*/ string _t309 = _STR("%"PRIu64"\000d", 2, secs / 3600 / 24);
	...
	if (secs > 3600 * 24 * 10000) {
		/*tmp return var*/ string _t310 = _SLIT("");
	...
	/*tmp return var*/ string _t311 = time__Time_md(t);
...
int time__day_of_week(int y, int m, int d) {
	...
	/*tmp return var*/ int _t312 = (sy + sy / 4 - sy / 100 + sy / 400 + (*(int*)/*ee elem_typ */array_get(t, m - 1)) + d - 1) % 7 + 1;
...
int time__Time_day_of_week(time__Time t) {
	/*tmp return var*/ int _t313 = time__day_of_week(t.year, t.month, t.day);
...
string time__Time_weekday_str(time__Time t) {
	...
	/*tmp return var*/ string _t314 = string_substr(_const_time__days_string, i * 3, (i + 1) * 3);
...
string time__Time_long_weekday_str(time__Time t) {
	int i = time__Time_day_of_week(t) - 1;
	/*tmp return var*/ string _t315 = (*(string*)/*ee elem_typ */array_get(_const_time__long_days, i));
...
i64 time__ticks(void) {
	#if defined(_WIN32)
	{
		/*tmp return var*/ i64 _t316 = GetTickCount();
...
bool time__is_leap_year(int year) {
	/*tmp return var*/ bool _t317 = (year % 4 == 0) && (year % 100 != 0 || year % 400 == 0);
...
Option_int time__days_in_month(int month, int year) {
	...
	Option_int _t318;
	opt_ok(&(int[]) { res }, (Option*)(&_t318), sizeof(int));
	return _t318;
}

string time__Time_str(time__Time t) {
	/*tmp return var*/ string _t319 = time__Time_format_ss(t);
...
VV_LOCAL_SYMBOL time__Time time__convert_ctime(struct tm t, int microsecond) {
	/*tmp return var*/ time__Time _t320 = (time__Time){
		.year = t.tm_year + 1900,
		.month = t.tm_mon + 1,
		.day = t.tm_mday,
		.hour = t.tm_hour,
...
// TypeDecl
i64 time__Duration_nanoseconds(time__Duration d) {
	/*tmp return var*/ i64 _t321 = ((i64)(d));
...
i64 time__Duration_microseconds(time__Duration d) {
	/*tmp return var*/ i64 _t322 = ((i64)(d)) / 1000;
...
i64 time__Duration_milliseconds(time__Duration d) {
	/*tmp return var*/ i64 _t323 = ((i64)(d)) / 1000000;
...
f64 time__Duration_seconds(time__Duration d) {
	...
	/*tmp return var*/ f64 _t324 = ((f64)(sec)) + ((f64)(nsec)) / 1e9;
...
f64 time__Duration_minutes(time__Duration d) {
	...
	/*tmp return var*/ f64 _t325 = ((f64)(min)) + ((f64)(nsec)) / (60 * 1e9);
...
f64 time__Duration_hours(time__Duration d) {
	...
	/*tmp return var*/ f64 _t326 = ((f64)(hr)) + ((f64)(nsec)) / (60 * 60 * 1e9);
...
int time__offset(void) {
	...
	/*tmp return var*/ int _t327 = ((int)(local.v_unix - t.v_unix));
...
VV_LOCAL_SYMBOL int time__make_unix_time(struct tm t) {
	/*tmp return var*/ int _t328 = ((int)(_mkgmtime(&t)));
...
u64 time__sys_mono_now(void) {
	...
	/*tmp return var*/ u64 _t329 = (tm - _const_time__start_time) * 1000000000 / _const_time__freq_time;
...
VV_LOCAL_SYMBOL int time__local_as_unix_time(void) {
	...
	/*tmp return var*/ int _t330 = time__make_unix_time(*tm);
...
int time__SystemTime_unix_time(time__SystemTime st) {
	...
	/*tmp return var*/ int _t331 = time__make_unix_time(tt);
...
time__Time time__darwin_now(void) {
	/*tmp return var*/ time__Time _t332 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
...
time__Time time__linux_now(void) {
	/*tmp return var*/ time__Time _t333 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
...
time__Time time__solaris_now(void) {
	/*tmp return var*/ time__Time _t334 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
...
time__Time time__darwin_utc(void) {
	/*tmp return var*/ time__Time _t335 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
...
time__Time time__linux_utc(void) {
	/*tmp return var*/ time__Time _t336 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
...
time__Time time__solaris_utc(void) {
	/*tmp return var*/ time__Time _t337 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
...
time__Time time__unix(int abs) {
	...
	int min = mr_528.arg1;
	int sec = mr_528.arg2;
	/*tmp return var*/ time__Time _t338 = (time__Time){
		.year = year,
		.month = month,
		.day = day,
		.hour = hr,
...
time__Time time__unix2(int abs, int microsecond) {
	...
	/*tmp return var*/ time__Time _t339 = (time__Time){
		.year = year,
		.month = month,
		.day = day,
		.hour = hr,
...
string term__format(string msg, string open, string close) {
	/*tmp return var*/ string _t340 = string_add(string_add(string_add(string_add(string_add(string_add(_SLIT("\x1b["), open), _SLIT("m")), msg), _SLIT("\x1b[")), close), _SLIT("m"));
...
string term__format_rgb(int r, int g, int b, string msg, string open, string close) {
	/*tmp return var*/ string _t341 = string_add(string_add(string_add(string_add(string_add(string_add(string_add(string_add(string_add(string_add(string_add(string_add(_SLIT("\x1b["), open), _SLIT(";2;")), int_str(r)), _SLIT(";")), int_str(g)), _SLIT(";")), int_str(b)), _SLIT("m")), msg), _SLIT("\x1b[")), close), _SLIT("m"));
...
string term__rgb(int r, int g, int b, string msg) {
	/*tmp return var*/ string _t342 = term__format_rgb(r, g, b, msg, _SLIT("38"), _SLIT("39"));
...
string term__bg_rgb(int r, int g, int b, string msg) {
	/*tmp return var*/ string _t343 = term__format_rgb(r, g, b, msg, _SLIT("48"), _SLIT("49"));
...
string term__hex(int hex, string msg) {
	/*tmp return var*/ string _t344 = term__format_rgb(hex >> 16, (hex >> 8 & 0xFF), (hex & 0xFF), msg, _SLIT("38"), _SLIT("39"));
...
string term__bg_hex(int hex, string msg) {
	/*tmp return var*/ string _t345 = term__format_rgb(hex >> 16, (hex >> 8 & 0xFF), (hex & 0xFF), msg, _SLIT("48"), _SLIT("49"));
...
string term__bg_black(string msg) {
	/*tmp return var*/ string _t346 = term__format(msg, _SLIT("40"), _SLIT("49"));
...
string term__bright_bg_black(string msg) {
	/*tmp return var*/ string _t347 = term__format(msg, _SLIT("100"), _SLIT("49"));
...
string term__bg_blue(string msg) {
	/*tmp return var*/ string _t348 = term__format(msg, _SLIT("44"), _SLIT("49"));
...
string term__bright_bg_blue(string msg) {
	/*tmp return var*/ string _t349 = term__format(msg, _SLIT("104"), _SLIT("49"));
...
string term__bg_cyan(string msg) {
	/*tmp return var*/ string _t350 = term__format(msg, _SLIT("46"), _SLIT("49"));
...
string term__bright_bg_cyan(string msg) {
	/*tmp return var*/ string _t351 = term__format(msg, _SLIT("106"), _SLIT("49"));
...
string term__bg_green(string msg) {
	/*tmp return var*/ string _t352 = term__format(msg, _SLIT("42"), _SLIT("49"));
...
string term__bright_bg_green(string msg) {
	/*tmp return var*/ string _t353 = term__format(msg, _SLIT("102"), _SLIT("49"));
...
string term__bg_magenta(string msg) {
	/*tmp return var*/ string _t354 = term__format(msg, _SLIT("45"), _SLIT("49"));
...
string term__bright_bg_magenta(string msg) {
	/*tmp return var*/ string _t355 = term__format(msg, _SLIT("105"), _SLIT("49"));
...
string term__bg_red(string msg) {
	/*tmp return var*/ string _t356 = term__format(msg, _SLIT("41"), _SLIT("49"));
...
string term__bright_bg_red(string msg) {
	/*tmp return var*/ string _t357 = term__format(msg, _SLIT("101"), _SLIT("49"));
...
string term__bg_white(string msg) {
	/*tmp return var*/ string _t358 = term__format(msg, _SLIT("47"), _SLIT("49"));
...
string term__bright_bg_white(string msg) {
	/*tmp return var*/ string _t359 = term__format(msg, _SLIT("107"), _SLIT("49"));
...
string term__bg_yellow(string msg) {
	/*tmp return var*/ string _t360 = term__format(msg, _SLIT("43"), _SLIT("49"));
...
string term__bright_bg_yellow(string msg) {
	/*tmp return var*/ string _t361 = term__format(msg, _SLIT("103"), _SLIT("49"));
...
string term__black(string msg) {
	/*tmp return var*/ string _t362 = term__format(msg, _SLIT("30"), _SLIT("39"));
...
string term__bright_black(string msg) {
	/*tmp return var*/ string _t363 = term__format(msg, _SLIT("90"), _SLIT("39"));
...
string term__blue(string msg) {
	/*tmp return var*/ string _t364 = term__format(msg, _SLIT("34"), _SLIT("39"));
...
string term__bright_blue(string msg) {
	/*tmp return var*/ string _t365 = term__format(msg, _SLIT("94"), _SLIT("39"));
...
string term__bold(string msg) {
	/*tmp return var*/ string _t366 = term__format(msg, _SLIT("1"), _SLIT("22"));
...
string term__cyan(string msg) {
	/*tmp return var*/ string _t367 = term__format(msg, _SLIT("36"), _SLIT("39"));
...
string term__bright_cyan(string msg) {
	/*tmp return var*/ string _t368 = term__format(msg, _SLIT("96"), _SLIT("39"));
...
string term__dim(string msg) {
	/*tmp return var*/ string _t369 = term__format(msg, _SLIT("2"), _SLIT("22"));
...
string term__green(string msg) {
	/*tmp return var*/ string _t370 = term__format(msg, _SLIT("32"), _SLIT("39"));
...
string term__bright_green(string msg) {
	/*tmp return var*/ string _t371 = term__format(msg, _SLIT("92"), _SLIT("39"));
...
string term__gray(string msg) {
	/*tmp return var*/ string _t372 = term__bright_black(msg);
...
string term__hidden(string msg) {
	/*tmp return var*/ string _t373 = term__format(msg, _SLIT("8"), _SLIT("28"));
...
string term__italic(string msg) {
	/*tmp return var*/ string _t374 = term__format(msg, _SLIT("3"), _SLIT("23"));
...
string term__inverse(string msg) {
	/*tmp return var*/ string _t375 = term__format(msg, _SLIT("7"), _SLIT("27"));
...
string term__magenta(string msg) {
	/*tmp return var*/ string _t376 = term__format(msg, _SLIT("35"), _SLIT("39"));
...
string term__bright_magenta(string msg) {
	/*tmp return var*/ string _t377 = term__format(msg, _SLIT("95"), _SLIT("39"));
...
string term__reset(string msg) {
	/*tmp return var*/ string _t378 = term__format(msg, _SLIT("0"), _SLIT("0"));
...
string term__red(string msg) {
	/*tmp return var*/ string _t379 = term__format(msg, _SLIT("31"), _SLIT("39"));
...
string term__bright_red(string msg) {
	/*tmp return var*/ string _t380 = term__format(msg, _SLIT("91"), _SLIT("39"));
...
string term__strikethrough(string msg) {
	/*tmp return var*/ string _t381 = term__format(msg, _SLIT("9"), _SLIT("29"));
...
string term__underline(string msg) {
	/*tmp return var*/ string _t382 = term__format(msg, _SLIT("4"), _SLIT("24"));
...
string term__white(string msg) {
	/*tmp return var*/ string _t383 = term__format(msg, _SLIT("37"), _SLIT("39"));
...
string term__bright_white(string msg) {
	/*tmp return var*/ string _t384 = term__format(msg, _SLIT("97"), _SLIT("39"));
...
string term__yellow(string msg) {
	/*tmp return var*/ string _t385 = term__format(msg, _SLIT("33"), _SLIT("39"));
...
string term__bright_yellow(string msg) {
	/*tmp return var*/ string _t386 = term__format(msg, _SLIT("93"), _SLIT("39"));
...
bool term__can_show_color_on_stdout(void) {
	/*tmp return var*/ bool _t387 = term__supports_escape_sequences(1);
...
bool term__can_show_color_on_stderr(void) {
	/*tmp return var*/ bool _t388 = term__supports_escape_sequences(2);
...
string term__ok_message(string s) {
	if (term__can_show_color_on_stdout()) {
		/*tmp return var*/ string _t389 = term__green(_STR(" %.*s\000 ", 2, s));
...
string term__fail_message(string s) {
	if (term__can_show_color_on_stdout()) {
		/*tmp return var*/ string _t390 = term__inverse(term__bg_white(term__bold(term__red(_STR(" %.*s\000 ", 2, s)))));
...
string term__warn_message(string s) {
	if (term__can_show_color_on_stdout()) {
		/*tmp return var*/ string _t391 = term__bright_yellow(_STR(" %.*s\000 ", 2, s));
...
string term__colorize(string (*cfn)(string ), string s) {
	if (term__can_show_color_on_stdout()) {
		/*tmp return var*/ string _t392 = cfn(s);
...
string term__h_divider(string divider) {
	...
	/*tmp return var*/ string _t393 = string_substr(result, 0, cols);
...
string term__header(string text, string divider) {
	if (text.len == 0) {
		/*tmp return var*/ string _t394 = term__h_divider(divider);
	...
	if (ln.len == 1) {
		/*tmp return var*/ string _t395 = string_add(string_add(string_add(string_add(ln, _SLIT(" ")), string_substr(text, 0, tlimit)), _SLIT(" ")), ln);
	...
	/*tmp return var*/ string _t396 = string_add(string_add(string_add(string_add(string_substr(ln, 0, tstart), _SLIT(" ")), string_substr(text, 0, tlimit)), _SLIT(" ")), string_substr(ln, tstart + tlimit + 2, cols));
...
VV_LOCAL_SYMBOL int term__imax(int x, int y) {
	/*tmp return var*/ int _t397 = (x > y ? (x) : (y));
...
VV_LOCAL_SYMBOL bool term__supports_escape_sequences(int fd) {
	...
	if (string_eq(vcolors_override, _SLIT("always"))) {
		/*tmp return var*/ bool _t398 = true;
	...
	if (string_eq(vcolors_override, _SLIT("never"))) {
		/*tmp return var*/ bool _t399 = false;
	...
	if (string_eq(os__getenv(_SLIT("TERM")), _SLIT("dumb"))) {
		/*tmp return var*/ bool _t400 = false;
	...
	#if defined(_WIN32)
	{
		if (string_eq(os__getenv(_SLIT("ConEmuANSI")), _SLIT("ON"))) {
			/*tmp return var*/ bool _t401 = true;
		...
		/*tmp return var*/ bool _t402 = ((is_atty(fd) & 0x0004)) > 0;
...
VV_LOCAL_SYMBOL void main__main(void) {
	Option_sqlite__DB _t403 = sqlite__connect(_SLIT("db.sqlite"));
	if (_t403.state != 0) { /*or block*/ 
		IError err = _t403.err;
		v_panic(IError_str(err));
	}
 	main__App* app = (main__App*)memdup(&(main__App){.db =  *(sqlite__DB*)_t403.data,.depths = new_map_2(sizeof(string), sizeof(int), &map_hash_string, &map_eq_string, &map_clone_string, &map_free_string),}, sizeof(main__App));
	multi_return_string_string mr_286 = (_const_os__args.len == 1 ? ((multi_return_string_string){.arg0=os__input(_SLIT("\nenter a starting Wikipedia entry: ")),.arg1=os__input(_SLIT("enter a target Wikipedia entry: "))}) : ((multi_return_string_string){.arg0=(*(string*)/*ee elem_typ */array_get(_const_os__args, 1)),.arg1=(*(string*)/*ee elem_typ */array_get(_const_os__args, 2))}));
	string start = mr_286.arg0;
	string target = mr_286.arg1;
	time__StopWatch start_time = time__new_stopwatch((time__StopWatchOptions){.auto_start = true,});
	Option_Array_string _t404 = main__App_find_path(app, start, target);
	if (_t404.state != 0) { /*or block*/ 
		IError err = _t404.err;
		eprintln(term__red(_STR("error: %.*s", 1, IError_str(err))));
		return;
	}
 	Array_string path =  *(Array_string*)_t404.data;
	println(_SLIT("found a path:"));
	// FOR IN array
	for (int i = 0; i < path.len; ++i) {
		string node = ((string*)path.data)[i];
		println(_STR(" %"PRId32"\000. %.*s", 2, i + 1, node));
	}
	f64 elapsed = ((f64)(time__Duration_milliseconds(time__StopWatch_elapsed(start_time)))) / 1000;
	println(_STR("\ntook %.2f\000 seconds", 2, elapsed));
}

VV_LOCAL_SYMBOL Array_string main__App_get(main__App* app, string db_entry) {
	Option_sqlite__Row _t405 = sqlite__DB_exec_one(app->db, _STR("SELECT links FROM data WHERE name = \"%.*s\000\"", 2, db_entry));
	if (_t405.state != 0) { /*or block*/ 
		IError err = _t405.err;
		/*tmp return var*/ Array_string _t406 = __new_array_with_default(0, 0, sizeof(string), 0);
		// autofree_scope_vars(pos=963 line_nr=38 scope.pos=962 scope.end_pos=974)
		// var "err" var.pos=962 var.line_nr=38
		// af parent scope:
		// var "app" var.pos=798 var.line_nr=36
		// var "db_entry" var.pos=811 var.line_nr=36
		// var "res" var.pos=885 var.line_nr=38
		// var "first" var.pos=978 var.line_nr=39
		// var "split" var.pos=1001 var.line_nr=40
		// af parent scope:
		// af parent scope:
		return _t406;
	}
 	sqlite__Row res =  *(sqlite__Row*)_t405.data;
	string first = (*(string*)/*ee elem_typ */array_get(res.vals, 0));
	Array_string split = string_split(first, _SLIT("\x01"));
	// autofree_scope_vars(pos=1031 line_nr=41 scope.pos=793 scope.end_pos=1046)
	// var "app" var.pos=798 var.line_nr=36
	// var "db_entry" var.pos=811 var.line_nr=36
	// var "res" var.pos=885 var.line_nr=38
	// var "first" var.pos=978 var.line_nr=39
...
VV_LOCAL_SYMBOL Option_Array_string main__App_find_path(main__App* app, string start, string target) {
	if (main__App_get(app, start).len == 0) {
		return (Option_Array_string){.state=2, .err=v_error(_STR("start page `%.*s\000` not in the database", 2, start)) };
	}
	if (main__App_get(app, target).len == 0) {
		return (Option_Array_string){.state=2, .err=v_error(_STR("target page `%.*s\000` not in the database", 2, target)) };
	}
	for (int depth = 1; ; depth++) {
		Array_string path = main__App_dfs(app, start, target, 0, depth, __new_array_with_default(0, 0, sizeof(string), 0));
		if (path.len > 0) {
			Option_Array_string _t407;
			opt_ok(&(Array_string[]) { path }, (Option*)(&_t407), sizeof(Array_string));
			return _t407;
		}
	}
	Option_Array_string _t408;
	opt_ok(&(Array_string[]) { __new_array_with_default(0, 0, sizeof(string), 0) }, (Option*)(&_t408), sizeof(Array_string));
	return _t408;
}

VV_LOCAL_SYMBOL Array_string main__App_dfs(main__App* app, string node, string target, int depth, int limit, Array_string path_) {
	if (string_eq(node, target)) {
		Array_string path = array_clone(&path_);
		array_push(&path, _MOV((string[]){ string_clone(node) }));
		// autofree_scope_vars(pos=1983 line_nr=72 scope.pos=1934 scope.end_pos=1998)
		// var "path" var.pos=1943 var.line_nr=70
		// af parent scope:
		// var "app" var.pos=1824 var.line_nr=68
		// var "node" var.pos=1837 var.line_nr=68
		// var "target" var.pos=1850 var.line_nr=68
		// var "depth" var.pos=1865 var.line_nr=68
		// var "limit" var.pos=1876 var.line_nr=68
		// var "path_" var.pos=1887 var.line_nr=68
		// af parent scope:
		// af parent scope:
		return path;
	}
	if (depth > limit) {
		map_set_1(&app->depths, &(string[]){node}, &(int[]) { depth });
		/*tmp return var*/ Array_string _t410 = __new_array_with_default(0, 0, sizeof(string), 0);
		// autofree_scope_vars(pos=2053 line_nr=77 scope.pos=2021 scope.end_pos=2066)
		// af parent scope:
		// var "app" var.pos=1824 var.line_nr=68
		// var "node" var.pos=1837 var.line_nr=68
		// var "target" var.pos=1850 var.line_nr=68
	...
	if ((*(int*)map_get_1(ADDR(map, app->depths), &(string[]){node}, &(int[]){ 0 })) >= limit - depth) {
		/*tmp return var*/ Array_string _t411 = __new_array_with_default(0, 0, sizeof(string), 0);
		// autofree_scope_vars(pos=2113 line_nr=81 scope.pos=2109 scope.end_pos=2126)
		// af parent scope:
		// var "app" var.pos=1824 var.line_nr=68
		// var "node" var.pos=1837 var.line_nr=68
		// var "target" var.pos=1850 var.line_nr=68
	...
	if (limit > depth + 1) {
		Array_string children = main__App_get(app, node);
		Array_string path = array_clone(&path_);
		array_push(&path, _MOV((string[]){ string_clone(node) }));
		// FOR IN array
		for (int _t413 = 0; _t413 < children.len; ++_t413) {
			string child = ((string*)children.data)[_t413];
			Array_string res = main__App_dfs(app, child, target, depth + 1, limit, path);
			if (res.len > 0) {
				// autofree_scope_vars(pos=2339 line_nr=91 scope.pos=2333 scope.end_pos=2355)
				// af parent scope:
				// var "child" var.pos=2236 var.line_nr=88
				// skipping tmp var "child"
				// var "res" var.pos=2260 var.line_nr=89
				// af parent scope:
				// var "children" var.pos=2158 var.line_nr=85
				// var "path" var.pos=2191 var.line_nr=86
				// af parent scope:
				// var "app" var.pos=1824 var.line_nr=68
				// var "node" var.pos=1837 var.line_nr=68
				// var "target" var.pos=1850 var.line_nr=68
	...
	map_set_1(&app->depths, &(string[]){node}, &(int[]) { limit - depth });
	/*tmp return var*/ Array_string _t414 = __new_array_with_default(0, 0, sizeof(string), 0);
	// autofree_scope_vars(pos=2404 line_nr=97 scope.pos=1819 scope.end_pos=2416)
	// var "app" var.pos=1824 var.line_nr=68
	// var "node" var.pos=1837 var.line_nr=68
	// var "target" var.pos=1850 var.line_nr=68
	// var "depth" var.pos=1865 var.line_nr=68
