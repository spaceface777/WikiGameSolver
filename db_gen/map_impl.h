...
static map	new_map(int key_bytes, int value_bytes, MapHashFn hash_fn, MapEqFn key_eq_fn, MapCloneFn clone_fn,
					MapFreeFn free_fn);
map			map_move(map* m);
...
map new_map(int key_bytes, int value_bytes, MapHashFn hash_fn, MapEqFn key_eq_fn, MapCloneFn clone_fn,
			MapFreeFn free_fn) {
